...
ANALYSTS = {
    ...
    "macro": {
        ...
        "sources":     ["Macro RSS", "Reuters RSS", "AP RSS", "MarketWatch RSS", "Yahoo Finance RSS", "Seeking Alpha RSS", "Investing.com RSS", "Motley Fool RSS", "Barrons RSS", "Google News RSS", "GDELT", "Social Signal"],
        "weight":      3,
    ...
    "sentiment": {
        ...
        "sources":     ["Fear & Greed", "Benzinga RSS", "Social Signal", "Reddit"],
        "weight":      2,
